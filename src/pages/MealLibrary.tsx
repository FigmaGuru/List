      ...
      <header className="pt-safe bg-white border-b border-border/60 px-4 pt-4 pb-3">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-400 mt-0.5">{meals.length} meals in your library</p>
          </div>
          <Button size="fab" onClick={() => setAddOpen(true)} className="h-12 w-12 rounded-full shadow-fab">
