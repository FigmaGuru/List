...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      ...
      {children}
      <DialogPrimitive.Close className="absolute right-5 top-5 rounded-full p-1.5 text-gray-400 dark:text-gray-500 transition hover:text-gray-600 dark:hover:text-gray-300 focus:outline-none">
        <X className="h-5 w-5" />
