...
export function BottomNav() {
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 bg-white/95 dark:bg-gray-950/95 backdrop-blur border-t border-gray-100 dark:border-gray-800">
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              cn(
                ...
                isActive ? 'text-[#7ececa]' : 'text-gray-400 dark:text-gray-600',
              )
            }
          >
            {({ isActive }) => (
              <>
                <span className={cn(
                  ...
                  isActive && 'bg-[#e8f8f7] dark:bg-[#1a3a38] scale-110',
                )}>
