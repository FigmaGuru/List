  ...
  theme: {
    extend: {
      colors: {
        ...
        // Semantic tokens — all powered by CSS vars so dark mode is free
        ...
        'teal-subtle-hover':'var(--color-teal-subtle-hover)',
        ring:               '#0f766e',
      },
      fontFamily: {
        sans: [
      ...
      boxShadow: {
        ...
        'card-hover': '0 4px 20px 0 rgba(0,0,0,0.10), 0 1px 4px 0 rgba(0,0,0,0.06)',
